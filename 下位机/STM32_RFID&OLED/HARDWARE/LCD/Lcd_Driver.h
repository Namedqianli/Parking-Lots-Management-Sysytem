...
#define LCD_SCL        	GPIO_Pin_12	//PB11--->>TFT --SCL/SCK
#define LCD_SDA        	GPIO_Pin_11	//PB10 MOSI--->>TFT --SDA/DIN
#define LCD_CS        	GPIO_Pin_13  //PA7--->>TFT --CS/CE

#define LCD_LED        	GPIO_Pin_12  //PA6--->>TFT --BL
#define LCD_RS         	GPIO_Pin_14	//PB0--->>TFT --RS/DC
#define LCD_RST     		GPIO_Pin_15	//PB1--->>TFT --RST
